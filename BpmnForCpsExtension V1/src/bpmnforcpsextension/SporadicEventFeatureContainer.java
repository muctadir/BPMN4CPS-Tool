...
public class SporadicEventFeatureContainer extends CustomShapeFeatureContainer {
	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "BpmnForCpsExtension.customTaskSporadicevent";

	public SporadicEventFeatureContainer() {
	}

	@Override
	public String getId(EObject object) {
		// This is where we inspect the object to determine what its custom task ID should be.
		// In this case, the object will be a SporadicEvent instance.
		if (object instanceof SporadicEvent)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof SporadicEvent ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateSporadicEventFeature(fp);
			}
	...
	public class CreateSporadicEventFeature extends AbstractCreateEventDefinitionFeature<SporadicEvent> {

		public CreateSporadicEventFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getSporadicEvent();
		}
