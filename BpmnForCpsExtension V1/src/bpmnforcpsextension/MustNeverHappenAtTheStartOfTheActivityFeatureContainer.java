...
public class MustNeverHappenAtTheStartOfTheActivityFeatureContainer extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.MNHST";

	public MustNeverHappenAtTheStartOfTheActivityFeatureContainer() {
	}
	...
	public String getId(EObject object) {
		...
		if (object instanceof MustNeverHappenAtTheStartOfTheActivity)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof MustNeverHappenAtTheStartOfTheActivity ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMustNeverHappenAtTheStartOfAnActivityFeature(fp);
			}
	...
	public class CreateMustNeverHappenAtTheStartOfAnActivityFeature extends AbstractCreateEventDefinitionFeature<MustNeverHappenAtTheStartOfTheActivity> {

		public CreateMustNeverHappenAtTheStartOfAnActivityFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMustNeverHappenAtTheStartOfTheActivity();
		}
