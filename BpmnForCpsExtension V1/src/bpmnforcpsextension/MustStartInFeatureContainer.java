...
public class MustStartInFeatureContainer extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.msi";

	public MustStartInFeatureContainer() {
	}
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof MSI ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMSIFeature(fp);
			}
	...
	public class CreateMSIFeature extends AbstractCreateEventDefinitionFeature<MSI> {

		public CreateMSIFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMSI();
		}
