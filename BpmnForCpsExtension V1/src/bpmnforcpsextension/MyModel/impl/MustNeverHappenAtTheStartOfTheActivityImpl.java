...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Must Never Happen At The Start Of The Activity</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getName <em>Name</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getType <em>Type</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getDo_Happen <em>Do Happen</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getFirst_physical_property <em>First physical property</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getMin_value_of_the_first_physical_property <em>Min value of the first physical property</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getMax_value_of_the_first_physical_property <em>Max value of the first physical property</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getSecond_physical_property <em>Second physical property</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getMin_value_of_the_second_physical_property <em>Min value of the second physical property</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getMax_value_of_the_second_physical_property <em>Max value of the second physical property</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getThird_physical_property <em>Third physical property</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getMin_value_of_the_third_physical_property <em>Min value of the third physical property</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getMax_value_of_the_third_physical_property <em>Max value of the third physical property</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MustNeverHappenAtTheStartOfTheActivityImpl#getPhysical_dependency_function <em>Physical dependency function</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MustNeverHappenAtTheStartOfTheActivityImpl extends EventDefinitionImpl implements MustNeverHappenAtTheStartOfTheActivity {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TYPE_EDEFAULT = "MNHST";
	 ...
	 * @generated
	 */
	protected MustNeverHappenAtTheStartOfTheActivityImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MyModelPackage.Literals.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__TYPE, oldType, type));
	}
	...
	public Activity getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Activity newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__TARGET, oldTarget, target));
	}
	...
	public void setDo_Happen(String newDo_Happen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__DO_HAPPEN, oldDo_Happen, do_Happen));
	}
	...
	public void setFirst_physical_property(String newFirst_physical_property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__FIRST_PHYSICAL_PROPERTY, oldFirst_physical_property, first_physical_property));
	}
	...
	public void setMin_value_of_the_first_physical_property(String newMin_value_of_the_first_physical_property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MIN_VALUE_OF_THE_FIRST_PHYSICAL_PROPERTY, oldMin_value_of_the_first_physical_property, min_value_of_the_first_physical_property));
	}
	...
	public void setMax_value_of_the_first_physical_property(String newMax_value_of_the_first_physical_property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MAX_VALUE_OF_THE_FIRST_PHYSICAL_PROPERTY, oldMax_value_of_the_first_physical_property, max_value_of_the_first_physical_property));
	}
	...
	public void setSecond_physical_property(String newSecond_physical_property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__SECOND_PHYSICAL_PROPERTY, oldSecond_physical_property, second_physical_property));
	}
	...
	public void setMin_value_of_the_second_physical_property(String newMin_value_of_the_second_physical_property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MIN_VALUE_OF_THE_SECOND_PHYSICAL_PROPERTY, oldMin_value_of_the_second_physical_property, min_value_of_the_second_physical_property));
	}
	...
	public void setMax_value_of_the_second_physical_property(String newMax_value_of_the_second_physical_property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MAX_VALUE_OF_THE_SECOND_PHYSICAL_PROPERTY, oldMax_value_of_the_second_physical_property, max_value_of_the_second_physical_property));
	}
	...
	public void setThird_physical_property(String newThird_physical_property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__THIRD_PHYSICAL_PROPERTY, oldThird_physical_property, third_physical_property));
	}
	...
	public void setMin_value_of_the_third_physical_property(String newMin_value_of_the_third_physical_property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MIN_VALUE_OF_THE_THIRD_PHYSICAL_PROPERTY, oldMin_value_of_the_third_physical_property, min_value_of_the_third_physical_property));
	}
	...
	public void setMax_value_of_the_third_physical_property(String newMax_value_of_the_third_physical_property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MAX_VALUE_OF_THE_THIRD_PHYSICAL_PROPERTY, oldMax_value_of_the_third_physical_property, max_value_of_the_third_physical_property));
	}
	...
	public void setPhysical_dependency_function(String newPhysical_dependency_function) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__PHYSICAL_DEPENDENCY_FUNCTION, oldPhysical_dependency_function, physical_dependency_function));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__NAME:
				return getName();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__TYPE:
				return getType();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__TARGET:
				if (resolve) return getTarget();
				return basicGetTarget();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__DO_HAPPEN:
				return getDo_Happen();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__FIRST_PHYSICAL_PROPERTY:
				return getFirst_physical_property();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MIN_VALUE_OF_THE_FIRST_PHYSICAL_PROPERTY:
				return getMin_value_of_the_first_physical_property();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MAX_VALUE_OF_THE_FIRST_PHYSICAL_PROPERTY:
				return getMax_value_of_the_first_physical_property();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__SECOND_PHYSICAL_PROPERTY:
				return getSecond_physical_property();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MIN_VALUE_OF_THE_SECOND_PHYSICAL_PROPERTY:
				return getMin_value_of_the_second_physical_property();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MAX_VALUE_OF_THE_SECOND_PHYSICAL_PROPERTY:
				return getMax_value_of_the_second_physical_property();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__THIRD_PHYSICAL_PROPERTY:
				return getThird_physical_property();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MIN_VALUE_OF_THE_THIRD_PHYSICAL_PROPERTY:
				return getMin_value_of_the_third_physical_property();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__MAX_VALUE_OF_THE_THIRD_PHYSICAL_PROPERTY:
				return getMax_value_of_the_third_physical_property();
			case MyModelPackage.MUST_NEVER_HAPPEN_AT_THE_START_OF_THE_ACTIVITY__PHYSICAL_DEPENDENCY_FUNCTION:
...
} //MustNeverHappenAtTheStartOfTheActivityImpl
