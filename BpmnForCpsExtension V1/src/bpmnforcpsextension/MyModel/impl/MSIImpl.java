...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MSI</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MSIImpl#getName <em>Name</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MSIImpl#getType <em>Type</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MSIImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MSIImpl#getMin_Value <em>Min Value</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MSIImpl#getMax_Value <em>Max Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MSIImpl extends EventDefinitionImpl implements MSI {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TYPE_EDEFAULT = "MSI";
	...
	protected EClass eStaticClass() {
		return MyModelPackage.Literals.MSI;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MSI__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MSI__TYPE, oldType, type));
	}
	...
	public Activity getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyModelPackage.MSI__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Activity newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MSI__TARGET, oldTarget, target));
	}
	...
	public void setMin_Value(String newMin_Value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MSI__MIN_VALUE, oldMin_Value, min_Value));
	}
	...
	public void setMax_Value(String newMax_Value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MSI__MAX_VALUE, oldMax_Value, max_Value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MyModelPackage.MSI__NAME:
				return getName();
			case MyModelPackage.MSI__TYPE:
				return getType();
			case MyModelPackage.MSI__TARGET:
				if (resolve) return getTarget();
				return basicGetTarget();
			case MyModelPackage.MSI__MIN_VALUE:
				return getMin_Value();
			case MyModelPackage.MSI__MAX_VALUE:
				return getMax_Value();
		}
