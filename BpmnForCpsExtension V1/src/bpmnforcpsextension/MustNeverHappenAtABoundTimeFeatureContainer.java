...
public class MustNeverHappenAtABoundTimeFeatureContainer extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.MNHBT";

	public MustNeverHappenAtABoundTimeFeatureContainer() {
	}
	...
	public String getId(EObject object) {
		...
		if (object instanceof MustNeverHappenAtABoundTime)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof MustNeverHappenAtABoundTime ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMustNeverHappenAtABoundTimeFeature(fp);
			}
	...
	public class CreateMustNeverHappenAtABoundTimeFeature extends AbstractCreateEventDefinitionFeature<MustNeverHappenAtABoundTime> {

		public CreateMustNeverHappenAtABoundTimeFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMustNeverHappenAtABoundTime();
		}
