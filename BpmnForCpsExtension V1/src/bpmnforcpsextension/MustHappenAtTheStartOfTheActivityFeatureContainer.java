...
public class MustHappenAtTheStartOfTheActivityFeatureContainer  extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.MHST";

	public MustHappenAtTheStartOfTheActivityFeatureContainer() {
	}
	...
	public String getId(EObject object) {
		...
		if (object instanceof MustHappenAtTheStartOfTheActivity)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof MustHappenAtTheStartOfTheActivity ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMustHappenAtTheStartOfAnActivityFeature(fp);
			}
	...
	public class CreateMustHappenAtTheStartOfAnActivityFeature extends AbstractCreateEventDefinitionFeature<MustHappenAtTheStartOfTheActivity> {

		public CreateMustHappenAtTheStartOfAnActivityFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMustHappenAtTheStartOfTheActivity();
		}
