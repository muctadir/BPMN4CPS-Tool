...
public class MustHappenAtAnInfiniteTimeFeatureContainer extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.MHIT";

	public MustHappenAtAnInfiniteTimeFeatureContainer() {
	}
	...
	public String getId(EObject object) {
		...
		if (object instanceof MustHappenAtAnInfiniteTime)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof MustHappenAtAnInfiniteTime ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMustHappenAtAnInfiniteTimeFeature(fp);
			}
	...
	public class CreateMustHappenAtAnInfiniteTimeFeature extends AbstractCreateEventDefinitionFeature<MustHappenAtAnInfiniteTime> {

		public CreateMustHappenAtAnInfiniteTimeFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMustHappenAtAnInfiniteTime();
		}
