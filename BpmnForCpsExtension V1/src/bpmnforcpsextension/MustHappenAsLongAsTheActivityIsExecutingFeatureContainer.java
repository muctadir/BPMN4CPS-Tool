...
public class MustHappenAsLongAsTheActivityIsExecutingFeatureContainer extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.MHALATAIE";

	public MustHappenAsLongAsTheActivityIsExecutingFeatureContainer() {
	}
	...
	public String getId(EObject object) {
		...
		if (object instanceof MustHappenAsLongAsTheActivityIsExecuting)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof MustHappenAsLongAsTheActivityIsExecuting ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMustHappenAsLongAsTheActivityIsExecutingFeature(fp);
			}
	...
	public class CreateMustHappenAsLongAsTheActivityIsExecutingFeature extends AbstractCreateEventDefinitionFeature<MustHappenAsLongAsTheActivityIsExecuting> {

		public CreateMustHappenAsLongAsTheActivityIsExecutingFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMustHappenAsLongAsTheActivityIsExecuting();
		}
