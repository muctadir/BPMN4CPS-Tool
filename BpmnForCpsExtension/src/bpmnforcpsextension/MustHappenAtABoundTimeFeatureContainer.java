...
public class MustHappenAtABoundTimeFeatureContainer  extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.MHBT";

	public MustHappenAtABoundTimeFeatureContainer() {
	}
	...
	public String getId(EObject object) {
		...
		if (object instanceof MustHappenAtABoundTime)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof MustHappenAtABoundTime ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMustHappenAtABoundTimeFeature(fp);
			}
	...
	public class CreateMustHappenAtABoundTimeFeature extends AbstractCreateEventDefinitionFeature<MustHappenAtABoundTime> {

		public CreateMustHappenAtABoundTimeFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMustHappenAtABoundTime();
		}
