		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION)
					{	
					textField.setText(chooser.getSelectedFile().getAbsolutePath()); //si un fichier est selectionné, récupérer le fichier puis sont path et l'afficher dans le champs de texte
				// Verif exemple = new Verif();
			    // System.out.println("helloiiiii");
					
			     /*String a= textField.getText();
			     File entryFile = new File(a);
			     Verif.parse(entryFile);*/
