...
import bpmnforcpsextension.SampleImageProvider.IconSize;

public class TextAnnotationPlusFeatureContainer  extends CustomShapeFeatureContainer {
	//public final static String Plus_ID = "org.eclipse.bpmn2.modeler.examples.customtas
	public final static String rweproperties_ID = "org.eclipse.bpmn2.modeler.examples.customtask.rweproperties";
	...
	public String getId(EObject object) {
		if (object instanceof TextAnnotation) {
			if (ModelDecorator.getAnyAttribute(object, "RWEproperties")!=null) {
				return rweproperties_ID; 
			}
