...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MOI</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MOIImpl#getName <em>Name</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MOIImpl#getType <em>Type</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MOIImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MOIImpl#getMin_Value <em>Min Value</em>}</li>
 *   <li>{@link bpmnforcpsextension.MyModel.impl.MOIImpl#getMax_Value <em>Max Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MOIImpl extends EventDefinitionImpl implements MOI {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TYPE_EDEFAULT = "MOI";
	...
	protected EClass eStaticClass() {
		return MyModelPackage.Literals.MOI;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MOI__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MOI__TYPE, oldType, type));
	}
	...
	public Activity getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyModelPackage.MOI__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Activity newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MOI__TARGET, oldTarget, target));
	}
	...
	public void setMin_Value(String newMin_Value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MOI__MIN_VALUE, oldMin_Value, min_Value));
	}
	...
	public void setMax_Value(String newMax_Value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MOI__MAX_VALUE, oldMax_Value, max_Value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MyModelPackage.MOI__NAME:
				return getName();
			case MyModelPackage.MOI__TYPE:
				return getType();
			case MyModelPackage.MOI__TARGET:
				if (resolve) return getTarget();
				return basicGetTarget();
			case MyModelPackage.MOI__MIN_VALUE:
				return getMin_Value();
			case MyModelPackage.MOI__MAX_VALUE:
				return getMax_Value();
		}
