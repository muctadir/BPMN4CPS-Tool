...
public class MustNeverHappenAtAnInfiniteTimeFeatureContainer extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.MNHIT";

	public MustNeverHappenAtAnInfiniteTimeFeatureContainer() {
	}
	...
	public String getId(EObject object) {
		...
		if (object instanceof MustNeverHappenAtAnInfiniteTime)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof MustNeverHappenAtAnInfiniteTime ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMustNeverHappenAtAnInfiniteTimeFeature(fp);
			}
	...
	public class CreateMustNeverHappenAtAnInfiniteTimeFeature extends AbstractCreateEventDefinitionFeature<MustNeverHappenAtAnInfiniteTime> {

		public CreateMustNeverHappenAtAnInfiniteTimeFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMustNeverHappenAtAnInfiniteTime();
		}
