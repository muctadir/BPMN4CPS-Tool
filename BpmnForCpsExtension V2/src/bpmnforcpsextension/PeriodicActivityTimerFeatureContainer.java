...
public class PeriodicActivityTimerFeatureContainer extends CustomShapeFeatureContainer {
	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "BpmnForCpsExtension.customTaskeventdef";

	public PeriodicActivityTimerFeatureContainer() {
	}

	@Override
	public String getId(EObject object) {
		// This is where we inspect the object to determine what its custom task ID should be.
		// In this case, the object will be a PeriodicEvent instance.
		if (object instanceof PeriodicEvent)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof PeriodicEvent ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreatePeriodicEventFeature(fp);
			}
	...
	public class CreatePeriodicEventFeature extends AbstractCreateEventDefinitionFeature<PeriodicEvent> {

		public CreatePeriodicEventFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getPeriodicEvent();
		}
