...
public class MustNeverHappenAsLongAsTheActivityIsExecutingFeatureContainer extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.MNHALATAIE";

	public MustNeverHappenAsLongAsTheActivityIsExecutingFeatureContainer() {
	}
	...
	public String getId(EObject object) {
		...
		if (object instanceof bpmnforcpsextension.MyModel.MustNeverHappenAsLongAsTheActivityIsExecuting)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof bpmnforcpsextension.MyModel.MustNeverHappenAsLongAsTheActivityIsExecuting ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMustNeverHappenAsLongAsTheActivityIsExecutingFeature(fp);
			}
	...
	public class CreateMustNeverHappenAsLongAsTheActivityIsExecutingFeature extends AbstractCreateEventDefinitionFeature<bpmnforcpsextension.MyModel.MustNeverHappenAsLongAsTheActivityIsExecuting> {

		public CreateMustNeverHappenAsLongAsTheActivityIsExecutingFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMustNeverHappenAsLongAsTheActivityIsExecuting();
		}
