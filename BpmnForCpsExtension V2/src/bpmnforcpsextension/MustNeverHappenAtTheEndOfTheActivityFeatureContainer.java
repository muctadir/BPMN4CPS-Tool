...
public class MustNeverHappenAtTheEndOfTheActivityFeatureContainer  extends CustomShapeFeatureContainer {

	// this value must match what's in the plugin.xml
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.MNHFT";

	public MustNeverHappenAtTheEndOfTheActivityFeatureContainer() {
	}
	...
	public String getId(EObject object) {
		...
		if (object instanceof MustNeverHappenAtTheEndOfTheActivity)
	...
	public Object getApplyObject(IContext context) {
		if (context instanceof IPictogramElementContext) {
			...
			return bo instanceof MustNeverHappenAtTheEndOfTheActivity ? bo : null;
		}
		return null;
	}
	...
	protected IShapeFeatureContainer createFeatureContainer(IFeatureProvider fp) {
		return new AbstractEventDefinitionFeatureContainer() {
			...
			public ICreateFeature getCreateFeature(IFeatureProvider fp) {
				return new CreateMustNeverHappenAtTheEndOfAnActivityFeature(fp);
			}
	...
	public class CreateMustNeverHappenAtTheEndOfAnActivityFeature extends AbstractCreateEventDefinitionFeature<MustNeverHappenAtTheEndOfTheActivity> {

		public CreateMustNeverHappenAtTheEndOfAnActivityFeature(IFeatureProvider fp) {
			super(fp);
		}
		...
		public EClass getBusinessObjectClass() {
			return MyModelPackage.eINSTANCE.getMustNeverHappenAtTheEndOfTheActivity();
		}
